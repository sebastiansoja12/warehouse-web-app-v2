...
@SpringBootTest
@ActiveProfiles("dev")
public class TemporaryRerouteTest {

    @Autowired
    private TemporaryReroute temporaryReroute;
    ...
    @BeforeEach
    void tearDown() {
        temporaryRerouteTokenRepository.deleteAll();
    }
    ...
    void shouldGenerateRerouteToken() {
        ...
        // when
        final RerouteToken rerouteToken = temporaryReroute.generateReroutingToken(rerouteRequest);
    ...
    void shouldUpdateParcel() {
        ...
        // when
        temporaryReroute.updateParcel(updateParcelRequest);
        // then
    ...
    void shouldThrowParcelNotFoundIllegalArgumentException() {
        ...
        final NullPointerException exception = assertThrows(NullPointerException.class, () -> {
                temporaryReroute.updateParcel(null);
        });
        // then
    ...
    void shouldThrowWrongParcelIdTypeException() {
        ...
        final UpdateParcelRequest updateParcelRequest = createUpdateParcelRequest(INVALID_PARCEL_ID,
                updatedParcel);
        // when
        final Executable executable = () -> temporaryReroute.updateParcel(updateParcelRequest);
    ...
    void shouldValidateToken() {
        ...
        // when
        final RerouteToken validatedRerouteToken = temporaryReroute.validateReroutingToken(TOKEN);
        // then
    ...
    void tokenShouldBeExpired() {
        ...
        // when
        final boolean isTokenValid = temporaryReroute.tokenValidation(tokenValidationRequest);
    ...
    void shouldDeleteTokenByTokenValue() {
        // given && when
        final RerouteToken rerouteToken = temporaryReroute.generateReroutingToken(createRequest());
        temporaryReroute.deleteReroutingToken(rerouteToken.getToken());
