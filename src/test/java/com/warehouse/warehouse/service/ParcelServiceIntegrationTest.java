...
import com.warehouse.warehouse.configuration.ParcelServiceIntegrationTestConfiguration;
import com.warehouse.warehouse.inmemorydatabase.InMemoryParcelDatabase;
...
public class ParcelServiceIntegrationTest {
    ...
    @DatabaseSetup("/dataset/data001/parcel_repository.xml")
    @Test
